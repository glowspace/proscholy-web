<template>
    <div class="song-tags p-0 mt-3">
        <div class="d-inline-flex flex-row flex-wrap align-items-start mr-3"
            ...
            <nuxt-link to="/" class="tag tag-blue" v-if="song.liturgy_approval_status">{{
        ...
        <div class="d-inline-flex flex-row flex-wrap align-items-start"
            ...
            <nuxt-link class="tag tag-yellow songbook-tag" v-for="sb in song.songbook_records" :key="'sb' + sb.id"
